...
const ProjectDetail = () => {
  ...
  useEffect(() => {
    const selectedProject = projectData.find(proj => proj.nav === nav);
          ...
          <div className="row mt--40">
            <div className="col-lg-12">
              <div className="thumbnail-project-details-top">
                <img src={project.mainImage} alt="project_details" style={{display: "block", margin: "auto", height: "500px"}}/>
          ...
          <div className="row">
            <div className="col-lg-12">
              <div className="next-prev-product-details">
                <span className="left"> <i className="fa-light"><FontAwesomeIcon icon={faArrowLeft} /></i> Předchozí </span>
                ...
                <span className="left">Další <i className="fa-light "><FontAwesomeIcon icon={faArrowRight} /></i></span>
              </div>
            </div>
          </div>
        </div>
