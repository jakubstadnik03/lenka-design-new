          ...
          <div className="container">
            <div className="row">
              ...
              <div className="col-lg-8 mt_md--50 mt_sm--50">
                  ...
                  <div className="large-image">
                    <img
                      ...
                      style={{
                        height: "400px",
                        objectFit:
                          service.style === "contain" ? "contain" : "cover",
                      }}
                    />{" "}
                  </div>
                  <h3 className="title-main-s">{service.title}</h3>
                ...
                <h3 className="title-main-s">{service.title2}</h3>
                ...
                <div className="row mt--40">
                  ...
                  <div className="col-lg-8">
                    <p className="disc mb--10">
                      Každého z nás ovlivňuje a formuje, jak bydlíme, někdy
                      stačí jen málo a dojde k veliké změně a člověk se doma
                      cítí hned lépe.
                    </p>
                    <p className="disc">
