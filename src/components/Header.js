  ...
  return (
    <>
        ...
        <div className={`mobile-menu-main ${isMobileMenuOpen ? 'open' : ''}`}>
          <nav className="nav-main mainmenu-nav mt--30">
            <ul className="mainmenu metismenu" id="mobile-menu-active">
              <li>
                <Link className="main" to="/" onClick={closeMobileMenu}>Domů</Link>
              </li>
              <li className="has-dropdown">
                <Link className="main" to="/o-nas" onClick={closeMobileMenu}>O nás</Link>
              </li>
      ...
      >
              ...
              <li>
                <Link className="main" to="/blog" onClick={closeMobileMenu}>Blog</Link>
              </li>
              <li>
                <Link className="main" to="/cenik" onClick={closeMobileMenu}>Ceník</Link>
              </li>
              <li>
                <Link className="main" to="/kontakt" onClick={closeMobileMenu}>Kontaktovat</Link>
              </li>
            </ul>
          </nav>
        </div>
