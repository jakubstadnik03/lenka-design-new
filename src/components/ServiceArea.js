  ...
  return (
    <div className="service-area-start rts-service-area rts-section-gap bg-inner-light">
      <div className="container">
        <div className="row">
          <div className="col-lg-12">
            ...
            >
              ...
              <p className="disc">
                V Lenka Design se specializujeme na vytváření mimořádných
                obytných prostor, které vyzařují eleganci.
              </p>
              <a
                href="/nase-sluzby"
        ...
        <div
          className="row mt--20 g-5 rts-slide-up"
        ...
        >
          {servicesData.slice(0, 4).map((service, index) => (
            ...
            >
              <div
                className="single-service-style-five"
                style={{ width: "300px" }}
              >
